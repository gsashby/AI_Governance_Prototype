...
const RECOMMENDATIONS: Recommendation[] = [
  ...
  // ── Model Performance ──────────────────────────────────────────────────────
  {
    ...
    actions: [
      ...
      'Notify the AI Ethics team and open a formal incident ticket — this rate is above the reportable threshold under the organization\'s AI ethics policy.',
  ...
  },
  {
    ...
    actions: [
      ...
      'Review Agent Workflows session configuration for any recent changes to system prompt length or tool definitions that could increase tokens-per-request.',
